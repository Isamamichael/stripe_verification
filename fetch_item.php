...
if($statement->execute())
{
	...
	{
		$output .= '
		<div class="col-md-3 col-sm-12 col-xs-6" style="margin-top:12px;">  
            <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px; height:100%;" align="center">
				...
				<h4>Check "Your Choices" in order to enroll</h4>
            </div>
        </div>
		';
	}
